...
buffer_ui_rect_2d :: proc(rect_coords: Rect2D_NDC, color: Color3) {
    ...
    offset := imui_buffers.buffered_rect_2d * verticies_byte_size
...
imui_menu_button :: proc(dimensions: Rect2D_NDC) -> bool {
    ...
    imui_buffers.buffered_rect_2d += 1
...
draw_buffered_ui_rect_2d :: proc() {
    ...
    verticies := imui_buffers.buffered_rect_2d * 6
    gl.DrawArrays(gl.TRIANGLES, 0, i32(verticies))

    imui_buffers.buffered_rect_2d = 0
